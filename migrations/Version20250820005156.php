 ...
 */
final class Version20250820005156 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_C7A2EC1B7E3C61F9 ON container (owner_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_C7A2EC1B7E3C61F9 ON container');
    }
}
