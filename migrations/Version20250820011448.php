 ...
 */
final class Version20250820011448 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dish ADD owner_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_957D8CB87E3C61F9 ON dish');
        $this->addSql('ALTER TABLE dish DROP owner_id');
    }
}
